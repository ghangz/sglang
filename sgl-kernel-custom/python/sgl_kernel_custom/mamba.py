...
def causal_conv1d_fwd(
    ...
    torch.ops.sgl_kernel_custom.causal_conv1d_fwd(
        x,
        weight,
        bias_,
        conv_states,
...
def causal_conv1d_update(
    ...
    torch.ops.sgl_kernel_custom.causal_conv1d_update(
        x,
        conv_state,
        weight,
        bias_,
...
def causal_conv1d_fn_cpu(
    ...
    return torch.ops.sgl_kernel_custom.causal_conv1d_fwd_cpu(
        mixed_qkv_transposed,
        conv_weights,
        bias,
        conv_states,
...
def causal_conv1d_update_cpu(
    ...
    return torch.ops.sgl_kernel_custom.causal_conv1d_update_cpu(
        mixed_qkv,
        conv_states,
        conv_weights,
        bias,
...
def chunk_gated_delta_rule_cpu(
    ...
    core_attn_out, last_recurrent_state = (
        torch.ops.sgl_kernel_custom.chunk_gated_delta_rule_cpu(
            q,
            k,
            v,
            g,
