...
def merge_state(
    ...
    torch.ops.sgl_kernel_custom.merge_state.default(v_a, s_a, v_b, s_b, v_merged, s_merged)
...
def merge_state_v2(
    ...
    if s_merged is None:
        s_merged = torch.empty_like(s_a)
    torch.ops.sgl_kernel_custom.merge_state_v2.default(v_a, s_a, v_b, s_b, v_merged, s_merged)
    return v_merged, s_merged
...
#     torch.ops.sgl_kernel_custom.cutlass_mla_decode.default(
#         out,
#         q_nope,
#         q_pe,
#         kv_c_and_k_pe_cache,
...
#     return torch.ops.sgl_kernel_custom.cutlass_mla_get_workspace_size.default(
