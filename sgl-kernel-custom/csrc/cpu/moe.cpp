...
at::Tensor fused_experts_cpu(
    ...
    bool is_vnni) {
  RECORD_FUNCTION(
      "sgl-kernel-custom::fused_experts_cpu", std::vector<c10::IValue>({hidden_states, w1, w2, topk_weights, topk_ids}));
...
at::Tensor shared_expert_cpu(
    ...
    const std::optional<std::vector<int64_t>> block_size,
    bool is_vnni) {
  RECORD_FUNCTION("sgl-kernel-custom::shared_expert_cpu", std::vector<c10::IValue>({hidden_states, w1, w2}));
