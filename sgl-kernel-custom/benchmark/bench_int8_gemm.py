...
import torch
import triton
from sgl_kernel_custom import int8_scaled_mm
...
if VLLM_AVAILABLE:
    line_vals = ["vllm", "sgl-kernel-custom"]
    line_names = ["vllm int8 gemm", "sgl-kernel-custom int8 gemm"]
    styles = [("blue", "-"), ("orange", "-")]
else:
    line_vals = ["sgl-kernel-custom"]
    line_names = ["sgl-kernel-custom int8 gemm"]
    styles = [("orange", "-")]
