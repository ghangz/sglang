...
import pytest
import torch
from sgl_kernel_custom import fp8_blockwise_scaled_grouped_mm
...
@pytest.mark.skipif(
    ...
    reason="fp8_blockwise_scaled_grouped_mm at sgl-kernel-custom is only supported on sm100 or sm90",
)
