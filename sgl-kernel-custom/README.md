...
[Kernel Library](https://github.com/sgl-project/sglang/tree/main/sgl-kernel-custom) for LLM inference engines
...
[![PyPI](https://img.shields.io/pypi/v/sgl-kernel-custom)](https://pypi.org/project/sgl-kernel-custom)

</div>

sgl-kernel-custom provides optimized compute primitives for LLM inference engines, enabling efficient inference for large language models and vision-language models through custom kernel operations. It has been used by [LightLLM](https://github.com/ModelTC/LightLLM), [SGLang](https://github.com/sgl-project/sglang) and so on.
...
```bash
# Latest version
pip3 install sgl-kernel-custom --upgrade
```
...
### Use Makefile to build sgl-kernel-custom
...
1. Implement the kernel in [csrc](https://github.com/sgl-project/sglang/tree/main/sgl-kernel-custom/csrc)
2. Expose the interface in [include/sgl_kernel_ops.h](https://github.com/sgl-project/sglang/blob/main/sgl-kernel-custom/include/sgl_kernel_ops.h)
3. Create torch extension in [csrc/common_extension.cc](https://github.com/sgl-project/sglang/blob/main/sgl-kernel-custom/csrc/common_extension.cc)
4. Update [CMakeLists.txt](https://github.com/sgl-project/sglang/blob/main/sgl-kernel-custom/CMakeLists.txt) to include new CUDA source
5. Expose Python interface in [python](https://github.com/sgl-project/sglang/blob/main/sgl-kernel-custom/python/sgl_kernel_custom)
...
1. Add pytest tests in [tests/](https://github.com/sgl-project/sglang/tree/main/sgl-kernel-custom/tests), if you need to skip some test, please use `@pytest.mark.skipif`
...
2. Add benchmarks using [triton benchmark](https://triton-lang.org/main/python-api/generated/triton.testing.Benchmark.html) in [benchmark/](https://github.com/sgl-project/sglang/tree/main/sgl-kernel-custom/benchmark)
...
python analyze_whl_kernel_sizes.py path/to/sgl_kernel_custom-*.whl

# Custom output file
python analyze_whl_kernel_sizes.py path/to/sgl_kernel_custom-*.whl --output my_analysis.txt
```
