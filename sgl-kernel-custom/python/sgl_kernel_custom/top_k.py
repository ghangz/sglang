...
def fast_topk_v2(
    ...
    torch.ops.sgl_kernel_custom.fast_topk(score, topk_indices, lengths, row_starts)
    return topk_indices
...
def fast_topk_transform_fused(
    ...
    torch.ops.sgl_kernel_custom.fast_topk_transform_fused(
...
def fast_topk_transform_ragged_fused(
    ...
    torch.ops.sgl_kernel_custom.fast_topk_transform_ragged_fused(
