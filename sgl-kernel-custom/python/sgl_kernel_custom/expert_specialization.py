...
def es_fp8_blockwise_scaled_grouped_mm(
    ...
    torch.ops.sgl_kernel_custom.es_fp8_blockwise_scaled_grouped_mm.default(
        output,
        a,
        b,
        scales_a,
...
def es_sm100_mxfp8_blockscaled_grouped_mm(
    ...
    torch.ops.sgl_kernel_custom.es_sm100_mxfp8_blockscaled_grouped_mm.default(
...
def es_sm100_mxfp8_blockscaled_grouped_quant(
    ...
    torch.ops.sgl_kernel_custom.es_sm100_mxfp8_blockscaled_grouped_quant.default(
        input,
        problem_sizes,
        expert_offsets,
        blockscale_offsets,
