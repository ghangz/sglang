...
std::tuple<at::Tensor, at::Tensor> per_token_quant_int8_cpu(at::Tensor& A) {
  RECORD_FUNCTION("sgl-kernel-custom::per_token_quant_int8_cpu", std::vector<c10::IValue>({A}));
...
at::Tensor int8_scaled_mm_cpu(
    ...
    bool is_vnni) {
  RECORD_FUNCTION("sgl-kernel-custom::int8_scaled_mm_cpu", std::vector<c10::IValue>({mat1, mat2, scales1, scales2, bias}));
...
at::Tensor int8_scaled_mm_with_quant(
    ...
    at::ScalarType out_dtype,
    bool is_vnni) {
  RECORD_FUNCTION("sgl-kernel-custom::int8_scaled_mm_cpu", std::vector<c10::IValue>({mat1, mat2, scales2, bias}));
