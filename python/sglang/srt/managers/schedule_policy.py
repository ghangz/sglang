...
class PrefillAdder:
    def __init__(
        ...
        self.chunked_prefill_size = rem_chunk_tokens
    ...
    def add_one_req_ignore_eos(self, req: Req, has_chunked_req: bool, truncation_align_size: Optional[int]):
        ...
        elif get_dcp_world_size() > 1 and req.extend_input_len < self.chunked_prefill_size:
            return AddReqResult.OTHER
        else:
    ...
    def add_one_req(
        ...
        if req.sampling_params.ignore_eos and getattr(self.tree_cache, "disable", True):
            return self.add_one_req_ignore_eos(req, has_chunked_req, truncation_align_size)
        ...
        with self._lock_node(req.last_node):
            ...
            elif get_dcp_world_size() > 1 and input_tokens < self.chunked_prefill_size:
                return AddReqResult.OTHER
            else:
