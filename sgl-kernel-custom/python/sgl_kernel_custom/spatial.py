...
_IMPORT_ERROR = ImportError(
    "Failed to load sgl_kernel_custom.spatial_ops extension. Ensure CUDA Driver >= 12.4"
)
...
def create_greenctx_stream_by_value(
    ...
    res = torch.ops.sgl_kernel_custom.create_greenctx_stream_by_value(SM_a, SM_b, device_id)
