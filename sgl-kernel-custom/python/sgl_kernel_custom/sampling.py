...
import torch
from sgl_kernel_custom.utils import _to_tensor_scalar_tuple
...
#     torch.ops.sgl_kernel_custom.top_k_renorm_probs.default(
...
#     renorm_probs = torch.empty_like(probs)
#     torch.ops.sgl_kernel_custom.top_p_renorm_probs.default(
...
#         torch.ops.sgl_kernel_custom.top_p_sampling_from_probs.default(
#             probs,
#             samples,
#             indices,
#             maybe_top_p_arr,
...
#         )
#         samples = torch.empty(probs.size(0), dtype=torch.int32, device=device)
#         torch.ops.sgl_kernel_custom.top_k_top_p_sampling_from_probs.default(
#             probs,
#             samples,
#             indices,
#             maybe_top_k_arr,
...
#         )
#         samples = torch.empty(probs.size(0), dtype=torch.int32, device=device)
#         torch.ops.sgl_kernel_custom.min_p_sampling_from_probs.default(
#             probs,
#             samples,
#             indices,
#             maybe_min_p_arr,
...
def _top_k_mask_logits_internal(
    ...
    torch.ops.sgl_kernel_custom.top_k_mask_logits.default(
