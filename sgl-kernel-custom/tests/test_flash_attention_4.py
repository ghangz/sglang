...
from sgl_kernel_custom.flash_attn import flash_attn_varlen_func, flash_attn_with_kvcache
from sgl_kernel_custom.testing.rotary_embedding import _apply_rotary_emb as apply_rotary_emb

# from utils import is_hopper  # Not used in this test

# Force sgl_kernel_custom.flash_attn wrappers to use FA4 (Cute-DSL) implementations.
