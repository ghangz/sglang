...
CACHE_DIR="${HOME}/.cache/sgl-kernel-custom"
...
BUILDER_NAME="sgl-kernel-custom-builder"
...
DEPS_TAG="sgl-kernel-custom-deps:cuda${CUDA_VERSION}-${PY_TAG}-${ARCH}"
...
if [ "${USE_CCACHE}" = "1" ]; then
  ...
  export CCACHE_BASEDIR=/sgl-kernel-custom
