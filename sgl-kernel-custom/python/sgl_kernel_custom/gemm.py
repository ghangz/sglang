...
import torch
from sgl_kernel_custom.scalar_type import ScalarType
from sgl_kernel_custom.utils import _get_cache_buf


def awq_dequantize(
    qweight: torch.Tensor, scales: torch.Tensor, qzeros: torch.Tensor
) -> torch.ByteTensor:
    return torch.ops.sgl_kernel_custom.awq_dequantize.default(qweight, scales, qzeros)


def int8_scaled_mm(mat_a, mat_b, scales_a, scales_b, out_dtype, bias=None):
    return torch.ops.sgl_kernel_custom.int8_scaled_mm.default(
        mat_a,
        mat_b,
        scales_a,
        scales_b,
...
#     return torch.ops.sgl_kernel_custom.fp8_blockwise_scaled_mm.default(
#         mat_a,
#         mat_b,
#         scales_a,
#         scales_b,
...
#     return torch.ops.sgl_kernel_custom.fp8_scaled_mm.default(
#         mat_a,
#         mat_b,
#         scales_a,
#         scales_b,
...
#     torch.ops.sgl_kernel_custom.bmm_fp8.default(
#         A,
#         B,
#         D,
#         A_scale,
...
#             dtype=mat_a.dtype,
#         )
#     torch.ops.sgl_kernel_custom.dsv3_fused_a_gemm.default(output, mat_a, mat_b)
#     return output
...
#     if enable_v2:
#         return torch.ops.sgl_kernel_custom.sgl_per_token_group_quant_8bit_v2.default(
#             input,
#             output_q,
#             output_s,
#             group_size,
...
#     torch.ops.sgl_kernel_custom.sgl_per_token_group_quant_8bit.default(
...
#     is_static: bool,
# ) -> None:
#     torch.ops.sgl_kernel_custom.sgl_per_tensor_quant_fp8.default(
...
#     output_s: torch.Tensor,
# ) -> None:
#     torch.ops.sgl_kernel_custom.sgl_per_token_quant_fp8.default(input, output_q, output_s)
...
#     torch.ops.sgl_kernel_custom.cutlass_scaled_fp4_mm.default(
...
#     torch.ops.sgl_kernel_custom.scaled_fp4_quant.default(
...
#             dtype=torch.float16,
#         )
#     torch.ops.sgl_kernel_custom.qserve_w4a8_per_chn_gemm.default(
...
#             dtype=torch.float16,
#         )
#     torch.ops.sgl_kernel_custom.qserve_w4a8_per_group_gemm.default(
...
def dsv3_router_gemm(
    ...
    torch.ops.sgl_kernel_custom.dsv3_router_gemm(
        output,
        hidden_states,
        router_weights,
    )
...
def shuffle_rows(input_tensor, dst2src_map, output_tensor_shape):
    ...
    torch.ops.sgl_kernel_custom.shuffle_rows.default(input_tensor, dst2src_map, output_tensor)
...
#     torch.ops.sgl_kernel_custom.silu_and_mul_scaled_fp4_experts_quant.default(
#         output.view(l * m, k // 2),
...
#             device=input_tensor.device,
#         )
#     torch.ops.sgl_kernel_custom.scaled_fp4_experts_quant.default(
#         output,
#         output_scales,
#         input_tensor,
#         input_global_scale,
...
# ) -> torch.Tensor:
#     return torch.ops.sgl_kernel_custom.gptq_marlin_gemm(
#         a,
#         c,
#         b_q_weight,
#         b_scales,
...
#     bit: int,
# ) -> torch.Tensor:
#     return torch.ops.sgl_kernel_custom.gptq_gemm(
#         a, b_q_weight, b_gptq_qzeros, b_gptq_scales, b_g_idx, use_shuffle, bit
#     )


# def gptq_shuffle(q_weight: torch.Tensor, q_perm: torch.Tensor, bit: int) -> None:
#     torch.torch.ops.sgl_kernel_custom.gptq_shuffle(q_weight, q_perm, bit)
