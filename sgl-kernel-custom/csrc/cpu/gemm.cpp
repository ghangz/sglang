...
weight_packed_linear(at::Tensor& mat1, at::Tensor& mat2, const std::optional<at::Tensor>& bias, bool is_vnni) {
  RECORD_FUNCTION("sgl-kernel-custom::weight_packed_linear", std::vector<c10::IValue>({mat1, mat2, bias}));
...
at::Tensor fused_linear_sigmoid_mul(
  ...
  RECORD_FUNCTION("sgl-kernel-custom::fused_linear_sigmoid_mul", std::vector<c10::IValue>({mat1, mat2, bias, post_mul_mat}));
