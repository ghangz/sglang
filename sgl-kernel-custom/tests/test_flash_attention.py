...
@pytest.mark.skipif(
    ...
    reason="flash_attn at sgl-kernel-custom is only supported on sm90 or sm80",
)
...
def test_flash_attn_kvcache(
    ...
    from sgl_kernel_custom.flash_attn import flash_attn_with_kvcache
...
def test_flash_attn_varlen_output(
    ...
    from sgl_kernel_custom.flash_attn import flash_attn_varlen_func
