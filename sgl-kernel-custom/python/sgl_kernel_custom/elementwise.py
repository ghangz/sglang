...
import torch
from sgl_kernel_custom.utils import is_arch_support_pdl
...
#     torch.ops.sgl_kernel_custom.rmsnorm.default(out, input, weight, eps, enable_pdl)
#     return out
...
def fused_add_rmsnorm(
    ...
    if enable_pdl is None:
        enable_pdl = is_arch_support_pdl()
    torch.ops.sgl_kernel_custom.fused_add_rmsnorm.default(
...
#     if enable_pdl is None:
#         enable_pdl = is_arch_support_pdl()
#     torch.ops.sgl_kernel_custom.gemma_rmsnorm.default(out, input, weight, eps, enable_pdl)
#     return out
...
#     if enable_pdl is None:
#         enable_pdl = is_arch_support_pdl()
#     torch.ops.sgl_kernel_custom.gemma_fused_add_rmsnorm.default(
#         input, residual, weight, eps, enable_pdl
#     )
...
def silu_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.sgl_kernel_custom.silu_and_mul.default(out, input)
    return out
...
def gelu_tanh_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.sgl_kernel_custom.gelu_tanh_and_mul.default(out, input)
    return out
...
def gelu_and_mul(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
    ...
    torch.ops.sgl_kernel_custom.gelu_and_mul.default(out, input)
    return out
...
if torch.version.hip is not None:
    ...
    def gelu_quick(input: torch.Tensor, out: torch.Tensor = None) -> torch.Tensor:
        ...
        torch.ops.sgl_kernel_custom.gelu_quick(out, input)
        return out
...
def apply_rope_with_cos_sin_cache_inplace(
    ...
    torch.ops.sgl_kernel_custom.apply_rope_pos_ids_cos_sin_cache.default(
...
def rotary_embedding(
    ...
    torch.ops.sgl_kernel_custom.rotary_embedding.default(
...
def concat_mla_k(
    ...
    torch.ops.sgl_kernel_custom.concat_mla_k(k, k_nope, k_rope)
...
def concat_mla_absorb_q(
    ...
    *batch_dims, _ = a.shape
    ...
    torch.ops.sgl_kernel_custom.concat_mla_absorb_q(a, b, out)
    return out
...
def timestep_embedding(
    ...
    return torch.ops.sgl_kernel_custom.timestep_embedding(
