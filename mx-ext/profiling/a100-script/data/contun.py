...
namedic = set()
a = defaultdict(int) 
with open('/home/m01149/torch_profile_analysis/a100-script/data/flashinfer_bs1_trace_a100.trace.txt', 'r') as file:
    for line in file:
        # 分割每行，假设每行由 ',' 分隔
        ...
        if len(parts) >= 2:
            ...
            if "flashinfer::" in kernel_name:
                flashinfer_number += 1
                namedic.add(kernel_name)
                a[kernel_name] +=1
...
print(f"flashinfer_number: {flashinfer_number}")
print(namedic)
print(a)
